...
이 페이지는 ‘감사모아 - 5개씩 감사일기 쓰기,다이어리’의  관련 데이터를 삭제하는 방법을 안내합니다.

‘감사모아 - 5개씩 감사일기 쓰기,다이어리’는 사용자의  Google 계정을 사용하여 인증하며, Google Drive에 데이터를 백업 및 저장합니다.
...
3. 삭제 가능한 데이터 유형
‘감사모아 - 5개씩 감사일기 쓰기,다이어리’의 앱 내 데이터는 사용자의 기기에만 저장됩니다.
...
‘감사모아 - 5개씩 감사일기 쓰기,다이어리’는 Google AdMob를 통해 광고를 제공합니다.
